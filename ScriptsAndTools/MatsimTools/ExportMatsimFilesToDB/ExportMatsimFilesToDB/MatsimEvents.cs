...
namespace ExportMatsimFilesToDB
{
        ...
        public void ExportToPostgreSQL(string connectionString)
        {
            ...
            try
            {
                ...
                foreach (var ev in matsimEvents)
                {
                    ...
                    //Console.WriteLine(ev.SQLValueString());
                ...
                while (reader.Read())
                {
                    switch (reader.NodeType)
                    {
                        case XmlNodeType.Element:
                            ...
                            {
                                float time;
                                if (!float.TryParse(reader.GetAttribute("time"), NumberStyles.Any, CultureInfo.InvariantCulture, out time))
                                    continue;
                                ...
                                switch (reader.GetAttribute("type"))
                                {
                                    ...
                                    case "vehicle leaves traffic":
                                        events.AddEvent(new MatsimLeavesTraffic(time,
                                            ...
                                            float.Parse(reader.GetAttribute("relativePosition"), NumberStyles.Any, CultureInfo.InvariantCulture))
                                            );
                                        break;
                                    case "wait2link":
                                    ...
                                    case "VehicleArrivesAtFacility":
                                        events.AddEvent(new MatsimVehicleArrivesAtFacility(time,
                                            ...
                                            float.Parse(reader.GetAttribute("delay"), NumberStyles.Any, CultureInfo.InvariantCulture))
                                            );
                                        break;
                                    ...
                                    case "travelled":
                                        events.AddEvent(new MatsimTravelled(time,
                                            reader.GetAttribute("type"),
                                            reader.GetAttribute("person"),
                                            double.Parse(reader.GetAttribute("distance"), NumberStyles.Any, CultureInfo.InvariantCulture))
                                            );
                                        break;
                                    case "stuckAndAbort":
    ...
    public class MatsimDriverStarts : MatsimEvent
    {
        ...
        public MatsimDriverStarts(float evTime, string evType, string did, string vid, string tid, string trid, string dpid)
            : base(evTime, evType)
        {
            driverId = did;
            vehicleId = vid;
    ...
    public class MatsimDeparture : MatsimEvent
    {
        ...
        public MatsimDeparture(float evTime, string evType, string p, string l, string lm)
            : base(evTime, evType)
        {
            person = p;
            link = l;
    ...
    public class MatsimArrival : MatsimEvent
    {
        ...
        public MatsimArrival(float evTime, string evType, string p, string l, string lm)
            : base(evTime, evType)
        {
            person = p;
            link = l;
    ...
    public class MatsimLeavesVehicle : MatsimEvent
    {
        ...
        public MatsimLeavesVehicle(float evTime, string evType, string p, string v)
            : base(evTime, evType)
        {
            person = p;
            vehicle = v;
    ...
    public class MatsimEntersVehicle : MatsimEvent
    {
        ...
        public MatsimEntersVehicle(float evTime, string evType, string p, string v)
            : base(evTime, evType)
        {
            person = p;
            vehicle = v;
    ...
    public class MatsimActEnd : MatsimEvent
    {
        ...
        public MatsimActEnd(float evTime, string evType, string p, string l, string at)
            : base(evTime, evType)
        {
            person = p;
            link = l;
    ...
    public class MatsimActStart : MatsimEvent
    {
        ...
        public MatsimActStart(float evTime, string evType, string p, string l, string at)
            : base(evTime, evType)
        {
            person = p;
            link = l;
    ...
    public class MatsimTravelled : MatsimEvent
    {
        ...
        public MatsimTravelled(float evTime, string evType, string p, double dist)
            : base(evTime, evType)
        {
            person = p;
            distance = dist;
    ...
    public class MatsimEnterLink : MatsimEvent
    {
        ...
        public MatsimEnterLink(float evTime, string evType, string p, string l, string v)
            : base(evTime, evType)
        {
            person = p;
            link = l;
    ...
    public class MatsimLeftLink : MatsimEvent
    {
        ...
        public MatsimLeftLink(float evTime, string evType, string p, string l, string v)
            : base(evTime, evType)
        {
            person = p;
            link = l;
    ...
    public class MatsimWait2Link : MatsimEvent
    {
        ...
        public MatsimWait2Link(float evTime, string evType, string p, string l, string v, string nm, float rp)
            : base(evTime, evType)
        {
            person = p;
            link = l;
    ...
    public class MatsimLeavesTraffic : MatsimEvent
    {
        ...
        public MatsimLeavesTraffic(float evTime, string evType, string p, string l, string v, string nm, float rp)
            : base(evTime, evType)
        {
            person = p;
            link = l;
    ...
    public class MatsimVehicleArrivesAtFacility : MatsimEvent
    {
        ...
        public MatsimVehicleArrivesAtFacility(float evTime, string evType, string veh, string fac, float del)
            : base(evTime, evType)
        {
            vehicle = veh;
            facility = fac;
    ...
    public class MatsimVehicleDepartsAtFacility : MatsimEvent
    {
        ...
        public MatsimVehicleDepartsAtFacility(float evTime, string evType, string veh, string fac, float del)
            : base(evTime, evType)
        {
            vehicle = veh;
            facility = fac;
    ...
    public class MatsimWaitingForPt : MatsimEvent
    {
        ...
        public MatsimWaitingForPt(float evTime, string evType, string ag, string at, string dest)
            : base(evTime, evType)
        {
            agent = ag;
            atStop = at;
    ...
    public class MatsimStuck : MatsimEvent
    {
        ...
        public MatsimStuck(float evTime, string evType, string p)
            : base(evTime, evType)
        {
            person = p;
        }

        public MatsimStuck(float evTime, string evType, string l, string leg, string p)
            : base(evTime, evType)
        {
            link = l;
            legMode = leg;
