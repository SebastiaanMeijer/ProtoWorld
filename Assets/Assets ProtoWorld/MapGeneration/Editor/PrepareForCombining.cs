...
public class PrepareForCombining : Editor
{
    ...
    [MenuItem("Gapslabs Extended Editor/Optimization/Group Close Buildings", false, 1)]
    static void PrepareForCombiningBuildings()
    {
    ...
    [MenuItem("Gapslabs Extended Editor/Optimization/Group Close Roads", false, 1)]
    static void PrepareForCombiningRoads()
    {
    ...
    /// </summary>
    [MenuItem("Gapslabs Extended Editor/Optimization/Turn Colliders off (Buildings)")]
    ...
    /// </summary>
    [MenuItem("Gapslabs Extended Editor/Optimization/Turn Colliders on (Buildings)")]
    ...
    /// </summary>
    [MenuItem("Gapslabs Extended Editor/Optimization/Turn Colliders off (Roads)")]
    ...
    /// </summary>
    [MenuItem("Gapslabs Extended Editor/Optimization/Turn Colliders on (Roads)")]
    ...
    /// </summary>
    [MenuItem("Gapslabs Extended Editor/Optimization/Remove Building Colliders")]
    ...
    /// </summary>
    [MenuItem("Gapslabs Extended Editor/Optimization/Remove Road Colliders")]
    ...
    //[MenuItem("Gapslabs Extended Editor/Optimization/Convert colliders to triggers")]
    ...
    //[MenuItem("Gapslabs Extended Editor/Optimization/Change Selected object height")]
    static void DecreaseHeight()
    {
        Selection.activeTransform.position = Selection.activeTransform.position + new Vector3(0, -0.3f, 0);
    }

    //[MenuItem("Gapslabs Extended Editor/Optimization/Show vertices #&v")]
    ...
    //[MenuItem("Gapslabs Extended Editor/Optimization/Convert Building colliders to triggers")]
    ...
    //[MenuItem("Gapslabs Extended Editor/Optimization/Combine Close Roads")]
